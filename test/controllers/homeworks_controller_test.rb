...
class HomeworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homework" do
    assert_difference("Homework.count") do
      post homeworks_url, params: { homework: { description: @homework.description, due_date: @homework.due_date, subject: @homework.subject, title: @homework.title } }
    end
  ...
  test "should update homework" do
    patch homework_url(@homework), params: { homework: { description: @homework.description, due_date: @homework.due_date, subject: @homework.subject, title: @homework.title } }
