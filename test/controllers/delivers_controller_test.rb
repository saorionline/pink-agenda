...
class DeliversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deliver" do
    assert_difference("Deliver.count") do
      post delivers_url, params: { deliver: { due_date: @deliver.due_date, homework_id: @deliver.homework_id } }
    end
  ...
  test "should update deliver" do
    patch deliver_url(@deliver), params: { deliver: { due_date: @deliver.due_date, homework_id: @deliver.homework_id } }
